...
while(iter < iterations)
    ...
    subplot(1,2,2);
    if iter>1
        stem(1:colonysize, prev_benefits, 'MarkerFaceColor','red', 'LineWidth', 2, 'MarkerSize', 6);
    end
    hold on;
    prev_benefits = benefits;
    stem(1:colonysize, benefits, 'MarkerFaceColor','black', 'LineWidth', 2, 'MarkerSize', 6);
    drawnow;
