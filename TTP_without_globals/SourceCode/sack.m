classdef sack
    ...
    methods
        ...
        %-----INIT-----%
        %--------------%
        function obj = sack(selectionList , items_weight , items_cost)
            
            obj.selection_list = selectionList;
            obj = cal_weight(obj,items_weight);
            obj = cal_cost(obj , items_cost);
            
        end
        %-------Calculate_weight-------%
        function obj = cal_weight(obj , items_weight)
           obj.weight = obj.selection_list * items_weight;
        end
        %-------Calculate_cost--------%
        function obj = cal_cost(obj , items_cost)
        ...
        %-----Weight-&-Cost--------%
        %--------------------------%
        function obj = modify_weight_cost(obj,removed_item_index , items_weight ,items_cost)
