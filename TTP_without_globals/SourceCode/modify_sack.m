function sack_obj = modify_sack(sack_obj,score_indices,string,capacity,items_weight ,items_cost)
        ...
        if(r>0.2)
            while(sack_obj.weight> capacity)
                ...
                if sack_obj.selection_list(score_indices(index))
                    ...
                    sack_obj = sack_obj.modify_weight_cost(score_indices(index),items_weight ,items_cost);
                end
                index = index-1;
                if(index == 0)
                    break;
           ...
           while(sack_obj.weight> capacity)
                ...
                if sack_obj.selection_list(random_index)
                    ...
                    sack_obj = sack_obj.modify_weight_cost(random_index,items_weight ,items_cost);
