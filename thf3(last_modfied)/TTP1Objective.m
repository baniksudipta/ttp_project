function [fp, ft, ob, Wend]=TTP1Objective(tour,z)
% inputs:
...
% City numbers start from 1
    global items_weight items_cost city_dist vmax vmin rent capacity;
    ...
    for i=1:length(tour)-1
        ...
        ft=ft+(city_dist(tour(i),tour(h))/(vmax-Wc*(vmax-vmin)/capacity)); 
    end;
    Wend = capacity - Wc;
    ob=fp-ft*rent;
end
